...
void test_matrix_base(void)
{
	...
	}
	{
		...
		std::cout << "matrix: " << std::endl;
		std::cout << matrix;
		Vector<float> vector = matrix.toVector();
...
void test_vector_base(void)
{
	try
	{
		...
		}
		{
			...
			std::cout << "vector: " << std::endl;
			std::cout << vector;
			Matrix<float> matrix = vector.toMatrix(3, 2);
			std::cout << "matrix result for a 3 x 2: " << std::endl;
			std::cout << matrix;
			Matrix<float> matrix2 = vector.toMatrix(2, 3);
			std::cout << "matrix2 result for a 2 x 3: " << std::endl;
			std::cout << matrix2 << std::endl;
		}
	}
